    ...
    return (
        <div className="max-w-6xl mx-auto bg-slate-50 min-h-screen font-sans text-slate-800">
            ...
            <div className="p-6">
                ...
                <div className="flex gap-4 mb-6 border-b border-slate-200">
                    ...
                    {isAdminReviewer && (
                        <button
                            ...
                            className={`pb-2 px-4 font-bold text-sm transition-colors ${activeTab === 'operations' ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-slate-500 hover:text-slate-700'}`}
                        >
                            5. 營運監控
                        </button>
                    )}
                ...
                {activeTab === 'operations' && isAdminReviewer && (
                    <OperationsDashboard />
                )}
