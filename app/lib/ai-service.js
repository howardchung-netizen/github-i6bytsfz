...
export const AI_SERVICE = {
    fetchQuestionBatch: async (count, level, selectedTopicIds = [], allTopicsList, subjectHint = null, user = null, selectedSubTopics = {}, adhdMode = false) => {
    ...
    generateQuestion: async (level, difficulty, selectedTopicIds = [], allTopicsList, subjectHint = null, user = null, languagePreference = null, selectedSubTopics = {}, adhdMode = false) => {
        const currentCacheKey = generateCacheKey(level, selectedTopicIds, subjectHint, user, difficulty, languagePreference, selectedSubTopics) + (adhdMode ? '_adhd' : '');
    ...
    generateQuestionDirect: async (
        ...
        const adhdInstruction = adhdMode ? `
        🧠 ADHD SUPPORT MODE ACTIVATED - CRITICAL FORMATTING REQUIREMENTS:
        The user has ADHD or learning difficulties. You MUST format the "question" and "explanation" fields specifically to reduce cognitive load:
        1. Keep sentences short and direct. Avoid complex nested clauses.
        2. Break information down into bullet points where possible.
        3. Use bolding (e.g., **keyword**) for crucial numbers, operators, or key constraints (like "buy", "left", "total", "cm").
        4. Add line breaks (\\n) between discrete pieces of information.
        5. DO NOT use walls of text. Provide plenty of visual breathing room.
    ` : '';
